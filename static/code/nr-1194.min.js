    ...
    function r(n) {
      if (n.info.beacon) {
        ...
        if (t) {
          ...
          w.jsonp("https://" + n.info.beacon + "/" + r + "/" + n.info.licenseKey + s, T)
        }
      }
    }
  ...
  32: [function(n, e, t) {
    ...
    function h(n) {
      ...
      return function(o, i) {
        ...
        a || (a = o[i.o] = []);
        var u = r[i.o];
        return "scrolling" !== n || w(i) ? u && i.s - u.s < t && u.e > i.s - e ? u.e = i.e : (r[i.o] = i, a.push(i)) : (r[i.o] = null, i.n = "scroll", a.push(i)), o
      }
    }
      ...
      if (e.exports = {
        ...
        q.on("feat-stn", function() {
          ...
          n.addEventListener("load", function() {
            ...
            var n = 0;
            return b.now() > 9e5 ? void(U = {}) : (j(U, function(e, t) {
              t && t.length && (n += t.length)
            }), n > 30 && k.sendX("resources", b), void(n > 1e3 && (U = {})))
          }, 1e4)
        });
        var C = 0
      }
